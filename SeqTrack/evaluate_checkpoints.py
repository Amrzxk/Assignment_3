"""Assignment 4 evaluation helper.

This script iterates through a list of SeqTrack checkpoints, runs the
official evaluation pipeline, aggregates the requested metrics and inference
statistics, and saves everything to ``evaluation_results.json``. It also
produces an optional inference log to mirror the training log format from
Assignment 3.
"""
