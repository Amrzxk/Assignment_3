...
class Assignment3Trainer:
    ...
    def setup_logging(self):
        ...
        log_file = 'assignment_3/training_log.txt'
    ...
    def create_mock_model(self):
        ...
        class MockSeqTrack(nn.Module):
            def __init__(self):
                super().__init__()
                self.encoder = nn.Conv2d(3, 256, kernel_size=self.patch_size, padding=0)
    ...
    def log_training_progress(self, epoch, batch_idx, loss, iou, batch_time):
        ...
        if batch_idx % self.print_interval == 0:
            ...
            remaining_samples = (self.epochs - epoch) * self.total_samples + (self.total_samples - batch_idx)
    ...
    def save_checkpoint(self, epoch, model, optimizer, loss):
        ...
        checkpoint_dir = 'assignment_3/checkpoints'
    ...
    def train(self):
        ...
        self.logger.info("Checkpoints saved in: assignment_3/checkpoints/")
        self.logger.info("Log file: assignment_3/training_log.txt")
        
        print("\n✅ Training completed successfully.")
        print("Checkpoints saved in: assignment_3/checkpoints/")
        print("Log file: assignment_3/training_log.txt")
